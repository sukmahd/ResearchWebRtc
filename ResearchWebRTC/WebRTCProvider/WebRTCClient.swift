...
final class WebRTCClient: NSObject {
    ...
    required init(iceServers: [String]) {
        ...
        config.iceServers = [
            ...
            RTCIceServer(urlStrings: ["turn:18.138.212.249:3478?transport=udp"], username: "qlue", credential: "Pejaten13!"),
            RTCIceServer(urlStrings: ["turn:18.138.212.249:3478?transport=tcp"], username: "qlue", credential: "Pejaten13!")
        ]
...
extension WebRTCClient: RTCPeerConnectionDelegate {
    ...
    func peerConnection(_ peerConnection: RTCPeerConnection, didChange newState: RTCIceGatheringState) {
        ...
        self.delegate?.webRTCCLient(self, didIceGatheringState: newState)
    }
